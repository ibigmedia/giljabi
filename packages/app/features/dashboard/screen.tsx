...
export function DashboardScreen() {
    ...
    return (
        <ScrollView bg="$backgroundBody" flex={1}>
            <YStack p="$4" gap="$6" maxWidth={1100} alignSelf="center" width="100%" py="$6">
                ...
                <XStack flexWrap="wrap" gap="$3">
                    {[
                        { title: '전체 멤버', value: '1,245', icon: Users, color: '$primary', bgColor: '$primaryContainer' },
                        { title: '활성 게시글', value: '342', icon: MessageSquare, color: '$secondary', bgColor: '$secondaryContainer' },
                        { title: '신규 그룹', value: '12', icon: TrendingUp, color: '$tertiary', bgColor: '$tertiaryContainer' },
                        { title: '참여율', value: '68%', icon: Activity, color: '$primary', bgColor: '$primaryContainer' },
                    ].map((metric, i) => {
                        ...
                        return (
                            ...
                            >
                                <XStack justifyContent="space-between" alignItems="center">
                                    <SizableText size="$3" color="$onSurfaceVariant" fontWeight="500">
                                        {metric.title}
                                    </SizableText>
                                    <XStack bg={metric.bgColor as any} p="$2" borderRadius="$lg">
                                        <Icon size={18} color={metric.color as any} />
                                    </XStack>
                                </XStack>
                ...
                <XStack flexWrap="wrap" gap="$4">
                    ...
                    >
                        <XStack justifyContent="space-between" alignItems="center" mb="$4">
                            <SizableText size="$5" fontWeight="700" color="$onSurface">
                                최근 활동
                            </SizableText>
                            <Button
                                size="$3"
                                ...
                                >
                                    ...
                                    <YStack flex={1} gap="$1">
                                        <XStack gap="$1" flexWrap="wrap">
                                            <SizableText fontWeight="700" color="$onSurface">
                                                사용자 {item}
                                            </SizableText>
                                            <SizableText color="$onSurfaceVariant">님이</SizableText>
                                            <SizableText fontWeight="600" color="$primary">
                                                일반 토론
                                            </SizableText>
                    ...
                    <YStack
                        ...
                        p="$5"
                    >
                        <SizableText size="$5" fontWeight="700" color="$onSurface" mb="$4">
                            인기 그룹
                        </SizableText>
                        <YStack gap="$4">
                            {['기술 나눔', '창작 예술', '스타트업'].map((group, i) => (
                                <XStack key={i} gap="$3" alignItems="center">
                                    ...
                                    <YStack flex={1}>
                                        <SizableText fontWeight="600" color="$onSurface">
                                            {group}
                                        </SizableText>
                                        <SizableText size="$2" color="$onSurfaceVariant">
                                            {120 - (i * 20)}명 활동중
                                    ...
                                    >
                                        <SizableText color="$onPrimaryContainer" fontWeight="600" size="$2">
                                            참여
                                        </SizableText>
                                    </Button>
                                </XStack>
